...
def main():
    ...
    indepedent_variables = ["StudyHours", "Attendance"]
    ...
    # If we compare model with all features and model with two feature [StudyHours and Attendance]
    # both have testing accuracy is 100%. Model is still peforming well with only 2 features.
