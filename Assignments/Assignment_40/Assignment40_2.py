...
def main():
    ...
    # SleepHours Removed
    indepedent_variables = ["StudyHours", "Attendance", "PreviousScore", "AssignmentsCompleted"]
    ...
    # Previous and new both showing 100% accuracy
    # Performance is not affect due to removing feature sleep hours
