...
def main():
    ...
    # Study hours affect in result.Study hours is directly proportional to previous score
    plt.figure(figsize=(8,6))
    scatter_plot_dataframe = ["StudyHours", "PreviousScore", "FinalResult"]
    sns.scatterplot(data= dataframe[scatter_plot_dataframe],x = "StudyHours", y= "PreviousScore", hue= "FinalResult")
    plt.show()
