...
def main():
    ...
    study_hours_correlation = dataframe["StudyHours"].corr(dataframe["FinalResult"])
    print("Study Hours Correlation with Final Result : ", study_hours_correlation) # 0.8505687777194799
    # Correlation is around 0.8505687777194799 which indicates strong relationship between
    # feature and label . This means that feature value increases, target label tends
    # to increase consistently
    
    attendance_correlation = dataframe["Attendance"].corr(dataframe["FinalResult"]) # 0.856455288845744
    print("Attendance correlation with Final Result", attendance_correlation)
    # Correlation is around 0.856455288845744 which indicates strong relationship between
    # feature and label . This means that feature value increases, target label tends
    # to increase consistently 
