...
#--------------------------------------------------------------
print("\nStep 3 : Spliting input and output")
...
#--------------------------------------------------------------
print("\nStep 4 : Spliting into training and testing data")
...
# predict proba gives confidence scores
#--------------------------------------------------------------
...
for i in range(len(data)):
    if data ["Placed"][i] == 1:
        plt.scatter(data["Aptitude"][i], data["Coding"][i], marker='o', label="Placed" if 1== 4 else"")
    else:
...
# loss curve stores the loss value after each iteration
#--------------------------------------------------------------
